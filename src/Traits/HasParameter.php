...
namespace YaangVu\LaravelBase\Traits;
...
use YaangVu\LaravelBase\Query\HasCondition;
use YaangVu\LaravelBase\Query\Sortable;
...
trait HasParameter
{
    ...
    public function deserialize(string $key, mixed $value): array
    {
        ...
        if ($operatorPattern === OperatorPatternEnum::LIKE) {
            $operator = ConditionMaker::make($this->driver)->like()->value;
            $value    = ConditionMaker::make($this->driver)->value($value);
        } else
